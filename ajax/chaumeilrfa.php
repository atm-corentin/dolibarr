...
/**
 *       \file       htdocs/clichaumeil/ajax/chaumeilrfa.php
 *       \brief      File to return Ajax response on chaumeilrfa list request
 */
...
dol_syslog("Call ajax clichaumeil/ajax/chaumeilrfa.php");
