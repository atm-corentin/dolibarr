...
/**
 *   	\file       chaumeilrfa_list.php
 *		\ingroup    clichaumeil
 *		\brief      List page for chaumeilrfa
 */
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ChaumeilRfa';
	$objectlabel = 'ChaumeilRfa';
	$uploaddir = $conf->clichaumeil->dir_output;
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/clichaumeil/chaumeilrfa_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendChaumeilRfaRef";
$modelmail = "chaumeilrfa";
$objecttmp = new ChaumeilRfa($db);
