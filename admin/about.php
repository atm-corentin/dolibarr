...
// *    \ingroup    clichaumeil
// *    \brief       About page of clichaumeil module
// *
...
//// Libraries
//require_once DOL_DOCUMENT_ROOT . '/core/lib/admin.lib.php';
////require_once '../lib/webhost.lib.php';
//require_once '../lib/clichaumeil.lib.php';
//
//// Translations
////$langs->load('webhost@webhost');
...
//
//$notab = -1;
////print dol_get_fiche_head($head, 'about', $langs->trans('Module104713Name'), $notab, 'webhost@webhost');
//print dol_get_fiche_head($head, 'about', $langs->trans('Module104321Name'), $notab, 'clichaumeil@clichaumeil');
//print dol_get_fiche_end($notab);
//
//require_once __DIR__ . '/../class/techatm.class.php';
////TODO ????????????????
//$techATM = new \ATM\WebHost\TechATM($db);
////$techATM = new \ATM\WebHost\TechATM($db);
//
