...
- NEW : R1-ACHT-4: Add client RFA management — separate supplier/client tabs on thirdparty card, global client RFA summary list backed by paid customer invoices, unified rebuild script and cron job (rfa_type parameter), yearly summary table extended with rfa_type discriminant column. *09/06/2026* - 1.17.0
