...
/**
 * 	\defgroup   marque     Module Marque
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/marque/core/modules directory.
 *  \file       htdocs/marque/core/modules/modMarque.class.php
 *  \ingroup    marque
 *  \brief      Description and activation file for module Marque
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Marque
 */
class modMarque extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->numero = 104015; // 104000 to 104999 for ATM CONSULTING
		$this->editor_name = 'ATM Consulting';
		$this->editor_url = 'https://www.atm-consulting.fr';
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'marque';
		...
		// for specific path of parts (eg: /marque/core/modules/barcode)
		// for specific css file (eg: /marque/css/marque.css.php)
		...
		//							'css' => array('/marque/css/marque.css.php'),	// Set this to relative path of css file if module has its own css file
		...
		// Example: this->dirs = array("/marque/temp");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into marque/admin directory, to use to setup module.
		$this->config_page_url = array("marque_setup.php@marque");
		...
		$this->langfiles = array("marque@marque");
		...
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:mylangfile@marque:$user->rights->marque->read:/marque/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:mylangfile@marque:$user->rights->othermodule->read:/marque/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        // Dictionaries
	    if (!isModEnabled('marque'))
        {
        	$conf->marque=new stdClass();
        	$conf->marque->enabled=0;
        }
        ...
        */
		...
		//							'titre'=>'Marque left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'marque',
		//							'url'=>'/marque/pagelevel2.php',
		//							'langs'=>'mylangfile@marque',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
