...
class Parsedown
{
	...
	/**
	 * Function to set $this->breaksEnabled
	 *
	 * @param bool $breaksEnabled variable to set
	 * @return $this
	 */
	...
	/**
	 * Function to set $this->markupEscaped
	 *
	 * @param bool $markupEscaped Markup escaped
	 * @return Parsedown $this
	 */
	...
	/**
	 * Function to set $this->urlsLinked
	 *
	 * @param array $urlsLinked URL Links
	 * @return Parsedown $this
	 */
	...
	/**
	 * Function to set $this->safeMode
	 *
	 * @param bool $safeMode Safe Mode
	 * @return Parsedown $this
	 */
	...
	/**
	 * Function to set $this->strictMode
	 *
	...
	protected function blockFencedCodeContinue($Line, $Block)
	{
		...
		if (preg_match('/^([' . preg_quote($Block['char']) . ']{3,})[ ]*$/', $Line['text'], $matches)
	...
	/**
	 * @param array $Line Line
	 * @param array|null $CurrentBlock Current Block
	 * @return array|void
	 */
	...
	protected function blockListContinue($Line, array $Block)
	{
		...
		if ($Line['indent'] < $requiredIndent
			and (($Block['data']['type'] === 'ol'
					and preg_match('/^[0-9]+' . preg_quote($Block['data']['markerType']) . '(?:[ ]+(.*)|$)/', $Line['text'], $matches)) or ($Block['data']['type'] === 'ul'
	...
	protected function blockSetextHeader($Line, array $Block = null)
	{
		...
		if (chop(chop($Line['text'], ' '), $Line['text'][0]) === ''
			and $Line['indent'] < 4
		) {
	...
	/**
	 * @param string $text Text
	 * @param array $nonNestables Non Nestable
	 * @return string
	 */
	...
	/**
	 * @param string $text Text
	 * @param bool $allowQuotes Allow quotes
	 * @return string
	 */
