    ...
    function MeiliParamsCreator(searchContext) {
        ...
        return {
            ...
            addDistinct: function () {
                var value = overrideParams === null || overrideParams === void 0 ? void 0 : overrideParams.distinct;
                if (value !== undefined) {
    ...
    function adaptHits(searchResponse, config) {
        ...
        var adaptedHits = hits.map(function (hit) {
            ...
            if (Object.keys(hit).length > 0) {
                var formattedHit = hit._formatted, _matchesPosition = hit._matchesPosition, documentFields = __rest(hit, ["_formatted", "_matchesPosition"]);
                var adaptedHit = Object.assign(documentFields, adaptFormattedFields(formattedHit));
                if ((_a = config === null || config === void 0 ? void 0 : config.meiliSearchParams) === null || _a === void 0 ? void 0 : _a.showMatchesPosition) {
