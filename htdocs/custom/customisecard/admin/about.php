...
/**
 * \file    customisecard/admin/about.php
 * \ingroup customisecard
 * \brief   About page of module CustomiseCard.
 */
...
require_once '../lib/customisecard.lib.php';
...
dol_fiche_head($head, 'about', '', 0, 'customisecard@customisecard');

dol_include_once('/customisecard/core/modules/modCustomiseCard.class.php');
$tmpmodule = new modCustomiseCard($db);
