...
/**
 * \file    test/phpunit/CustomiseCardFunctionalTest.php
...
/**
 * Class CustomiseCardFunctionalTest
 *
 ...
 *
 * @package Testcustomisecard
 */
class CustomiseCardFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCustomiseCard')->click();
		} else {
			// Disable the module
			$this->byHref('modCustomiseCard')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/customisecard/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('customisecard/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/customisecard/admin/about.php');
		$this->authenticate();
		return $this->assertContains('customisecard/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('customisecardwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCustomiseCard_CustomiseCardTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCustomiseCard_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
