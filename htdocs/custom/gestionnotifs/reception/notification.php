...
$filter = ' AND name_module ="reception" AND fk_module ='.$id;
...
print '<div id="notif_memebre">';
	print '<table class="noborder">';
		$arractions = array(
			'RECEPTION_VALIDATE' => $object::STATUS_VALIDATED,
			'RECEPTION_CLOSED' => $object::STATUS_CLOSED,
			'RECEPTION_BILLED' => $object::STATUS_VALIDATED,
			'RECEPTION_REOPEN' => $object::STATUS_VALIDATED,
			'RECEPTION_UNVALIDATE' => $object::STATUS_DRAFT,
		);
