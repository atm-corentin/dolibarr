...
$title = $langs->trans('Shipment')." - ".$langs->trans('notifications');
...
$filter = ' AND name_module ="shipping" AND fk_module ='.$id;
...
print '<div id="notif_memebre">';
	print '<table class="noborder">';
		$arractions = array(
			'SHIPPING_REOPEN' => $object::STATUS_VALIDATED,
			'SHIPPING_VALIDATE' => $object::STATUS_VALIDATED,
			'SHIPPING_CANCEL' => $object::STATUS_CANCELED,
			'SHIPPING_CLOSED' => $object::STATUS_CLOSED,
			'SHIPPING_BILLED' => $object::STATUS_VALIDATED,
		);
