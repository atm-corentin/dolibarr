...
/**
 * 	\defgroup   advancedictionaries     Module Advanced Dictionaries
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/advancedictionaries/core/modules directory.
 *  \file       htdocs/advancedictionaries/core/modules/modAdvanceDictionaries.class.php
 *  \ingroup    advancedictionaries
 *  \brief      Description and activation file for module Advanced Dictionaries
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Advanced Dictionaries
 */
class modAdvanceDictionaries extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 163017;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->config_page_url = array("setup.php@advancedictionaries");
        ...
        */
		...
		$r=0;
        $this->rights[$r][0] = 163028;	// Permission id (must not be already used)
        $this->rights[$r][1] = 'Read dictionaries';	// Permission label
        $this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
        $this->rights[$r][4] = 'read';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
        $r++;
        $this->rights[$r][0] = 163029;	// Permission id (must not be already used)
        $this->rights[$r][1] = 'Create and update dictionaries lines';	// Permission label
        $this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
        $this->rights[$r][4] = 'create';				// In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
        $r++;
        $this->rights[$r][0] = 163030;	// Permission id (must not be already used)
        $this->rights[$r][1] = 'Delete dictionaries lines';	// Permission label
        $this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
	...
	public function init($options='')
	{
        ...
        //$this->_load_tables('/pagessubstitution/sql/');

        // Create tables of all dictionaries
        dol_include_once('/advancedictionaries/class/dictionary.class.php');
        $dictionaries = Dictionary::fetchAllDictionaries($this->db, 'advancedictionaries');
