...
insert into llx_c_tva(fk_pays,taux,localtax1,localtax1_type,localtax2,localtax2_type,recuperableonly,note,active, entity) values (102,  16, 0, '0', 0, '0', 0, 'Νήσων κανονικός Φ.Π.Α.', 1, __ENTITY__);
...
insert into llx_c_tva(fk_pays,taux,recuperableonly,note,active, entity) values (6, '3.7','0','VAT rate - reduced',1, __ENTITY__);
insert into llx_c_tva(fk_pays,taux,recuperableonly,note,active, entity) values (6, '2.5','0','VAT rate - super-reduced',1, __ENTITY__);
insert into llx_c_tva(fk_pays,taux,recuperableonly,note,active, entity) values (6, '7.7','0','VAT rate - standard',1, __ENTITY__);
...
-- insert into llx_c_tva(fk_pays, taux, recuperableonly, note, active, entity) SELECT CONCAT(c.rowid, '1'), c.rowid, 0, 0, 'No VAT', 1 from llx_c_country as c where c.rowid not in (select fk_pays from llx_c_tva, __ENTITY__);
