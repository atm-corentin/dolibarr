...
/**
 * \file    test/phpunit/AdvancedHRMFunctionalTest.php
 * \ingroup advancedhrm
...
/**
 * Class AdvancedHRMFunctionalTest
 *
 ...
 *
 * @package Testadvancedhrm
 */
class AdvancedHRMFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAdvancedHRM')->click();
		} else {
			// Disable the module
			$this->byHref('modAdvancedHRM')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/advancedhrm/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('advancedhrm/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/advancedhrm/admin/about.php');
		$this->authenticate();
		return $this->assertContains('advancedhrm/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('advancedhrmwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAdvancedHRM_AdvancedHRMTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAdvancedHRM_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
