...
/**
 * 	\defgroup   extraitcompteclient     Module ExtraitCompteClient
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/extraitcompteclient/core/modules directory.
 *  \file       htdocs/extraitcompteclient/core/modules/modExtraitCompteClient.class.php
 *  \ingroup    extraitcompteclient
 *  \brief      Description and activation file for module ExtraitCompteClient
 */
include_once DOL_DOCUMENT_ROOT . '/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module ExtraitCompteClient
 */
class modExtraitCompteClient extends DolibarrModules
{
    var $extrafields;
	...
	public function __construct($db)
    {
        ...
        $this->numero = 163030;        // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'extraitcompteclient';
        ...
        $this->config_page_url = array("setup.php@extraitcompteclient");
        ...
        $r++;
        $this->const [$r] [0] = "MODULE_EXTRAITCOMPTECLIENT_VERSION";
        $this->const [$r] [1] = "chaine";
        $this->const [$r] [2] = $this->version;
        $this->const [$r] [3] = 'Version module extrait compte client';
        $this->const [$r] [4] = 0;
        ...
        if (!isset($conf->extraitcompteclient) || !isset($conf->extraitcompteclient->enabled)) {
            $conf->extraitcompteclient = new stdClass();
            $conf->extraitcompteclient->enabled = 0;
        }
        ...
        */
        ...
        $this->rights[$r][0] = 163061;
        $this->rights[$r][1] = $langs->trans('ExtraitCompteClientGenerateAccountStatutRightsLabel');
        $this->rights[$r][3] = 1;
        $this->rights[$r][4] = 'societe';
        $this->rights[$r][5] = 'generate_account_statut';
        $r++;
	...
	public function init($options='')
	{
        ...
        $this->_load_tables('/extraitcompteclient/sql/');
