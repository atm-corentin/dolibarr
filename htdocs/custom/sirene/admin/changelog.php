...
if ($isV14p) {
	print dol_get_fiche_head($head, 'changelog', $langs->trans("Module163027Name"), 0, 'opendsi@sirene');
} else {
	dol_fiche_head($head, 'changelog', $langs->trans("Module163027Name"), 0, 'opendsi@sirene');
}

$changelog = opendsi_common_getChangeLog('sirene');
