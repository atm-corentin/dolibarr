...
/**
 *  \file       chaumeilrfa_contact.php
 *  \ingroup    clichaumeil
 *  \brief      Tab for contacts linked to ChaumeilRfa
 */
...
$title = $langs->trans("ChaumeilRfa")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-clichaumeil page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("ChaumeilRfa"), -1, $object->picto);
