...
if (empty($reshook)) {
	...
	$triggermodname = 'CLICHAUMEIL_MYOBJECT_MODIFY'; // Name of trigger action code to execute when we modify record
	...
	$triggersendname = 'CLICHAUMEIL_MYOBJECT_SENTBYMAIL';
