...
//		);
	...
	public function init($options = '')
	{
		...
		$extrafields->addExtraField('clichaumeil_height_propaldet', 'CliChaumeilHeightPropalDet', 'double', 100, '24,2', 'propaldet', 0, 0, '', array ( 'options' => array ( '' => NULL, ), ), 1, '', '1', '', '', 0, 'clichaumeil@clichaumeil', 'isModEnabled("clichaumeil")', 0, '0', array ( 'css' => '', 'cssview' => '', 'csslist' => ''));
		$extrafields->addExtraField('clichaumeil_length_propaldet', 'CliChaumeilLengthPropalDet', 'double', 100, '24,2', 'propaldet', 0, 0, '', array ( 'options' => array ( '' => NULL, ), ), 1, '', '1', '', '', 0, 'clichaumeil@clichaumeil', 'isModEnabled("clichaumeil")', 0, '0', array ( 'css' => '', 'cssview' => '', 'csslist' => ''));
		$extrafields->addExtraField('clichaumeil_height_commandedet', 'CliChaumeilHeightCommandeDet', 'double', 100, '24,2', 'commandedet', 0, 0, '', array ( 'options' => array ( '' => NULL, ), ), 1, '', '1', '', '', 0, 'clichaumeil@clichaumeil', 'isModEnabled("clichaumeil")', 0, '0', array ( 'css' => '', 'cssview' => '', 'csslist' => ''));
		$extrafields->addExtraField('clichaumeil_length_commandedet', 'CliChaumeilLengthCommandeDet', 'double', 100, '24,2', 'commandedet', 0, 0, '', array ( 'options' => array ( '' => NULL, ), ), 1, '', '1', '', '', 0, 'clichaumeil@clichaumeil', 'isModEnabled("clichaumeil")', 0, '0', array ( 'css' => '', 'cssview' => '', 'csslist' => ''));
