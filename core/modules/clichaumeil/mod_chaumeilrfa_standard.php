...
/**
 *  \file       htdocs/core/modules/clichaumeil/mod_chaumeilrfa_standard.php
 *  \ingroup    clichaumeil
 ...
 */
class mod_chaumeilrfa_standard extends ModeleNumRefChaumeilRfa
{
	/**
	...
	public function getNextValue($object)
	{
		...
		if ($resql) {
			...
			dol_syslog("mod_chaumeilrfa_standard::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_chaumeilrfa_standard::getNextValue return ".$this->prefix.$yymm."-".$num);
