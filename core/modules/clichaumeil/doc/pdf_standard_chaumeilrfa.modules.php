...
/**
 *  \file       core/modules/clichaumeil/doc/pdf_standard.modules.php
 *  \ingroup    clichaumeil
...
/**
 *	Class to manage PDF template standard_chaumeilrfa
 */
class pdf_standard_chaumeilrfa extends ModelePDFChaumeilRfa
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	ChaumeilRfa	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('CLICHAUMEIL_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('CLICHAUMEIL_DRAFT_WATERMARK')));
		}
