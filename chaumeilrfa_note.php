...
/**
 *  \file       chaumeilrfa_note.php
 *  \ingroup    clichaumeil
 *  \brief      Tab for notes on ChaumeilRfa
 */
...
$langs->loadLangs(array("clichaumeil@clichaumeil", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->clichaumeil->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('ChaumeilRfa').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-clichaumeil page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("ChaumeilRfa"), -1, $object->picto);
